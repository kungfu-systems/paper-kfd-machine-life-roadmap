...
\begin{tabular}{rcl}
KFD-shaped semantic kernel & $\longrightarrow$ & subject and continuity \\
replaceable reasoning agents & $\longrightarrow$ & cognition \\
KFX extensions & $\longrightarrow$ & executable organs \\
machines and software supply chain & $\longrightarrow$ & body and metabolism \\
Agent Patrol and Dogfood & $\longrightarrow$ & sensing and feedback \\
Deprecation Lifecycle & $\longrightarrow$ & controlled retirement \\
recursive dogfood & $\longrightarrow$ & governed self-production
\end{tabular}
\medskip
...
\textbf{a falsifiable candidate for primitive machine life}
\end{minipage}}
...
agents, digital evolution, or self-modifying programs. It is an engineering
